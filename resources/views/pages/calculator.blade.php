        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <form wire:submit="calculate" class="space-y-6">
                ...
                <button
                    ...
                    class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-4 rounded-lg transition duration-200 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed">
                    <span wire:loading.remove>Calculate Stamp Duty</span>
